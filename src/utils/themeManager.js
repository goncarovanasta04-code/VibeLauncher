...
export const THEMES = [
  {
    id: 'vibe-classic',
    name: 'Vibe Motion (Дефолт)',
    description: 'Оригинальный анимированный живой видео-фон VibeLauncher с динамическими шейдерами',
    accent: '#38bdf8',
    accentSec: '#0ea5e9',
    accentIce: '#67e8f9',
  ...
  },
  {
    id: 'minimal-3d',
    name: '3D Монохром',
    description: 'Интерактивная 3D анимация: парящие многогранники и бесконечная сетка горизонта в ч/б стиле',
    accent: '#ffffff',
    accentSec: '#cbd5e1',
    accentIce: '#f8fafc',
  ...
  {
    id: '3d-cyber',
    name: '3D Cyber Matrix',
    description: 'Неоновые кристаллы, киберпанк-горизонт цвета индиго и электрические частицы',
    accent: '#06b6d4',
    accentSec: '#a855f7',
    accentIce: '#67e8f9',
  ...
  },
  {
    id: '3d-gold',
    name: '3D Solar Nexus',
    description: 'Сияющие золотые призмы, солнечный горизонт и теплые частицы звездной пыли',
    accent: '#f59e0b',
    accentSec: '#d97706',
    accentIce: '#fde047',
    ...
    tag: '3D Золото',
    iconKey: 'Sun',
    previewGradient: 'radial-gradient(circle at 50% 50%, #451a03 0%, #1c1917 60%, #0a0804 100%)',
  },
  {
    id: '3d-emerald',
    name: '3D Quantum Matrix',
    description: 'Квантовые изумрудные многогранники, глубокая матричная сетка и светлячки',
    accent: '#10b981',
    accentSec: '#059669',
    accentIce: '#6ee7b7',
    ...
    tag: '3D Квантум',
    iconKey: 'Sparkles',
    previewGradient: 'radial-gradient(circle at 50% 50%, #064e3b 0%, #022c22 60%, #020d08 100%)',
  },
  {
    id: 'minimal-black',
    name: 'Просто Чёрный',
...
export function getCurrentTheme() {
  try {
    ...
    return THEMES[0] // Default: vibe-classic (animated live video)
  } catch (e) {
    return THEMES[0]
  }
}
