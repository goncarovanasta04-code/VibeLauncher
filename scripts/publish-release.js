...
async function main() {
  ...
  const releaseNotes = `### ✨ VibeLauncher ${tagName} — Редизайн «Liquid Glass», восстановление 3D-темы и Discord-сервер

#### 🧊 Премиальный дизайн «Liquid Glass 2.0»
- **Полная эстетическая переработка:** все диалоговые и модальные окна (Настройки, Управление модами, Каталог тем, Авторизация, Список изменений) получили сверхсовременный полупрозрачный стиль матового стекла (*Liquid Glass*) с мягким размытием фона (\`backdrop-filter\`) и неоновыми световыми акцентами.
- **Отказ от серости и шаблонности:** переработана вся типографика, карточки, скроллбары и микро-анимации для ощущения премиального флагманского продукта.

#### 🌌 Возвращение классической 3D-темы «Полет кубиков» по умолчанию
- **Любимая 3D-сцена снова с нами:** по умолчанию в лаунчере запускается оригинальная интерактивная анимация, где объемные кубики и полиэдры плавно летят прямо в камеру сквозь бесконечную сетку горизонта.
- **Интерактивный параллакс:** сцена чутко реагирует на движения мыши с кинематографичным сглаживанием.
- **Новые визуальные баннеры и живые 3D-превью:** в каталоге тем каждая сцена снабжена уникальным графическим превью и реалтайм 3D-канвасом.

#### 🎮 Автоматическое появление Discord-сервера в Minecraft
- Лаунчер автоматически вносит сервер проекта в список сетевой игры (\`servers.dat\`) с чистым отображением ссылки на Discord без лишних префиксов.

#### 🚀 Производительность и надежность
- Сохранена полная совместимость с режимом **«Potato PC»**, защитой JVM от нехватки памяти и быстрым запуском любых сборок.`
